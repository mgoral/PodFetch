...
impl Invite{
    ...
    pub fn find_invite(id: String, conn: &mut AnyConnection) -> Result<Option<Invite>, diesel::result::Error> {
        invites::table
    ...
    pub fn find_all_invites(conn: &mut AnyConnection) -> Result<Vec<Invite>, diesel::result::Error> {
        invites::table
            .load::<Invite>(conn)
    }

    pub fn invalidate_invite(invite_id: String, conn: &mut AnyConnection) -> Result<(),
        diesel::result::Error> {
        use crate::dbconfig::schema::invites::dsl::*;
    ...
    pub fn delete_invite(invite_id: String, conn: &mut AnyConnection) -> Result<(), diesel::result::Error> {
        use crate::dbconfig::schema::invites::dsl::*;
